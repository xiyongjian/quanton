...
# xyj from zipline.gens.tradesimulation import AlgorithmSimulator
from gateway.tradesimulation import AlgorithmSimulator
...
# xyj from gateway import MinuteSimulationClock
...
""".strip().format(class_name=self.__class__.__name__,
    ...
    def _create_generator(self, sim_params):
        ...
        self.trading_client = AlgorithmSimulator(
            ...
            self.data_portal,
            # self._create_clock(),
            sim_engine.create_clock(self.clock_file),
